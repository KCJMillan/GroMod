...
void sortRemove(string gropath,string groname, string opath, int nbAtoms,int nbFrames,float frames[], float dtframe)
{
    ...
    else if (temp=="z>"){removeZsup(gropath,opath, groname, nbAtoms,nbFrames,frames,dtframe,nbToRemove,NameToRemove); cont=false; }
...
void removeZsup(string gropath,string opath,string groname, int nbAtoms,int nbFrames,float frames[], float dtframe, int nbToRemove, string NameToRemove)
